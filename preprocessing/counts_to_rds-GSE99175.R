...
files <- list.files(path = "../Data/GSE99175_RAW", recursive = TRUE, full.names = TRUE, pattern = "*.tsv.gz")
...
# Change the rownames to Gene Name
mart = useMart("ensembl", dataset="hsapiens_gene_ensembl")
#TranscriptID to GeneName
mart = useMart("ensembl", dataset = "hsapiens_gene_ensembl")
genesymb = getBM(attributes = c("ensembl_transcript_id","external_gene_name"),filters = 'ensembl_transcript_id', values = rownames(counts_all), mart = mart)
...
exportCount(counts_all, 'GSE99175', 'GSE99175')
